 ...
 */
@Singleton
public class AWSEC2ComputeServiceContextImpl extends EC2ComputeServiceContextImpl<AWSEC2Client, AWSEC2AsyncClient> implements AWSEC2ComputeServiceContext {
   @Inject
   public AWSEC2ComputeServiceContextImpl(AWSEC2ComputeService computeService, Map<String, Credentials> credentialStore,
