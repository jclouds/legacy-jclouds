...
public class AWSS3ClientLiveTest extends S3ClientLiveTest {
   ...
   public AWSS3Client getApi() {
      return (AWSS3Client) wrapper.unwrap(AWSS3ApiMetadata.CONTEXT_TOKEN).getApi();
   }
   ...
   public void testPutWithReducedRedundancyStorage() throws InterruptedException {
      ...
      try {
         ...
         S3Client s3Client = S3Client.class.cast(wrapper.unwrap(AWSS3ApiMetadata.CONTEXT_TOKEN).getApi());
