...
public class CloneAndRegisterMachineFromIsoIfNotAlreadyExistsTest extends
   ...
   public static final String TEST2 = "Name:            eth0\n"
         + "GUID:            30687465-0000-4000-8000-00261834d0cb\n"
         + "Dhcp:            Disabled\n" + "IPAddress:       209.x.x.x\n"
         + "NetworkMask:     255.255.255.0\n"
         + "IPV6Address:     fe80:0000:0000:0000:0226:18ff:fe34:d0cb\n"
   ...
   public void testCloneMachineFromAnotherMachine() throws IOException {
      ...
      IMachine clone = new CloneAndRegisterMachineFromIMachineIfNotAlreadyExists(
            ...
            forceOverwrite, cloneName, hostId).apply(master);
   }

   @Test
   public void retrieveAvailableBridgedInterfaceInfoTest() {
      assertFalse(CloneAndRegisterMachineFromIMachineIfNotAlreadyExists
            .retrieveAvailableBridgedInterfaceInfo(TEST1).isEmpty());
