...
public class VirtualHardDisk {
	...
	/**
	 * Specifies whether the OS disk can be cached for greater efficiency during writes. This setting impacts the consistency and performance of the OS disk. The default value is ReadWrite.
	 */
	...
	/**
	 * Specifies the URI for a blob in a Windows Azure storage account that contains the OS image to use to create the OS disk.
	 */
	...
	public String toString() {
		return "VirtualHardDisk [hostCaching=" + hostCaching + ", diskLabel="
