...
import org.jclouds.azure.servicemanagement.domain.virtualmachine.Protocol;
...
public class InputEndpoint {
	 ...
	 * element for a given endpoint adds it to the set.
	 */
	...
	public String toString() {
		return "InputEndpoint [enableDirectServerReturn="
				+ enableDirectServerReturn + ", loadBalancedEndpointSetName="
				+ loadBalancedEndpointSetName + ", localPort=" + localPort
				+ ", name=" + name + ", port=" + port + ", loadBalancerProbe="
				+ loadBalancerProbe + ", protocol=" + protocol + ", vip=" + vip
				+ "]";
	}
