...
public class LinuxProvisioningConfiguration extends ConfigurationSet {
	...
	public final static String ID = "LinuxProvisioningConfigurationSet";

	/**
	 *  Specifies the host name for the VM. Host names are ASCII character strings 1 to 64 characters in length.
	 */
//	@XmlElement(required = true,name = "HostName")
	private String hostName;
	/**
	 * Specifies the name of a user to be created in the sudoer group of the virtual machine. User names are ASCII character strings 1 to 32 characters in length.
	 */
//	@XmlElement(required = true,name = "UserName")
	private String userName;
	/**
	 *  Specifies the associated password for the user name. Passwords are ASCII character strings 6 to 72 characters in length.
	 */
//	@XmlElement(required = true,name = "UserPassword")
	private String userPassword;
	/**
	 * Specifies whether or not SSH password authentication is disabled. By default this value is set to true.
	 */
...
//	@XmlElement(name = "SSH")
	...
	public void setDisableSshPasswordAuthentication(
			Boolean disableSshPasswordAuthentication) {
	...
	public String toString() {
		return "LinuxProvisioningConfigurationSet [hostName=" + hostName
				+ ", userName=" + userName + ", userPassword=" + userPassword
				+ ", disableSshPasswordAuthentication="
				+ disableSshPasswordAuthentication + ", ssh=" + ssh + "]";
	}
