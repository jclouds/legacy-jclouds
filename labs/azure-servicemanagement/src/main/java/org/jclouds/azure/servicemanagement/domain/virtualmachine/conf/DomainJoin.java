...
public class DomainJoin {
	...
	/**
	 * Specifies the Domain, Password, and Username values to use to join the
	...
	public String toString() {
		return "DomainJoin [joinDomain=" + joinDomain + ", machineObjectOU="
				+ machineObjectOU + ", credentials=" + credentials + "]";
	}
