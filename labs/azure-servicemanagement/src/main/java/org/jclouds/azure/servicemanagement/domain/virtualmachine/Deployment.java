...
public class Deployment {
	...
	/**
	 * A name for the deployment. The deployment name must be unique among other
	 ...
	 * name can be used identify the hosted service for tracking purposes.
	 */
	...
	/**
	 * Specifies the name of an existing virtual network to which the deployment
	 * will belong.
	 * 
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((deploymentSlot == null) ? 0 : deploymentSlot.hashCode());
		...
		result = prime
				* result
				+ ((virtualNetworkName == null) ? 0 : virtualNetworkName
						.hashCode());
		return result;
	}
	...
	public String toString() {
		return "Deployment [name=" + name + ", deploymentSlot="
