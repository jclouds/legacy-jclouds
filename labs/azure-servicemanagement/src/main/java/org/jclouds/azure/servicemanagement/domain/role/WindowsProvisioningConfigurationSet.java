...
public class WindowsProvisioningConfigurationSet extends ConfigurationSet {
	...
	/**
	 * Specifies the base-64 encoded string representing the administrator
	 * password to use for the virtual machine.
	 */
	@XmlElement(required = true, name = "AdminPassword")
	private String adminPassword;
	/**
	 * Specifies whether the user must change the administrator password on
	 * first logon. The default value is false.
	 */
	 ...
	 * will be joined. The DomainJoin node contains either credentials or
	 * provisioning information.
	 */
	@XmlElement(name = "DomainJoin")
	private DomainJoin domainJoin;
	/**
	 * Contains a list of service certificates with which to provision to the
	 * new virtual machine.
	 */
	...
	public String toString() {
		return "WindowsProvisioningConfigurationSet [computerName="
				+ computerName + ", adminPassword=" + adminPassword
				+ ", resetPasswordOnFirstLogon=" + resetPasswordOnFirstLogon
				+ ", enableAutomaticUpdates=" + enableAutomaticUpdates
				+ ", timeZone=" + timeZone + ", domainJoin=" + domainJoin
