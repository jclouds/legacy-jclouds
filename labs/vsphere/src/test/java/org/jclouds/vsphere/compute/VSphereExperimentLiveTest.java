 ...
 * @author Andrea Turli
 */
@Test(groups = "live", singleThreaded = true, testName = "VSphereExperimentLiveTest")
public class VSphereExperimentLiveTest extends BaseVSphereClientLiveTest {
   ...
   @BeforeClass
   public void setUp() {
      context = ContextBuilder.newBuilder("vsphere").modules(
