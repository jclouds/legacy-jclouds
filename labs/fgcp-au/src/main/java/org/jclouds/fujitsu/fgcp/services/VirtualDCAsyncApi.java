...
public interface VirtualDCAsyncApi {
    ...
    ListenableFuture<Set<? extends ServerType>> listServerTypes();
    ...
    ListenableFuture<Set<EventLog>> getEventLog();

    @GET
    @JAXBResponseParser
    @QueryParams(keys = "Action", values = "GetEventLog")
    ListenableFuture<Set<EventLog>> getEventLog(@QueryParam("all") boolean all);
