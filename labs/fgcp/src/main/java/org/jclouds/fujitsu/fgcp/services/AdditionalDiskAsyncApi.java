...
public interface AdditionalDiskAsyncApi {
    ...
    ListenableFuture<Set<VDisk>> get(
            @BinderParam(BindAlsoToSystemId.class) @QueryParam("vdiskId") String id);
    ...
    ListenableFuture<Void> restore(
            @BinderParam(BindAlsoToSystemId.class) @QueryParam("backupId") String backupId);
    ...
    ListenableFuture<Void> detach(
            @BinderParam(BindAlsoToSystemId.class) @QueryParam("diskId") String diskId,
