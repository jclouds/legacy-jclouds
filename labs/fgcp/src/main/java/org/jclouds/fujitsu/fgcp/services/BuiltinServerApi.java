...
public interface BuiltinServerApi {
    ...
    // Set<> listEFMBackup(String id);
    /*
     * BackupEFM CreateEFM DestroyEFM DestroyEFMBackup GetEFMAttributes
     * GetEFMConfiguration GetEFMStatus ListEFM ListEFMBackup RestoreEFM
     * StartEFM StopEFM UpdateEFMAttribute UpdateEFMConfiguration
     */
}
