...
@Test(groups = "live", singleThreaded = true, testName = "MachineUtilsTest")
public class MachineUtilsTest extends BaseVirtualBoxClientLiveTest {
   ...
   public void testEnsureMachineIsPoweredOff() {
      ...
      assertTrue(machineUtils.isPoweredOff(vm.getVmSpec().getVmName()));
   }
