...
public class RecordSetApiExpectTest extends BaseRoute53ApiExpectTest {
   ...
   public void testListWhenResponseIs404() {
      ...
      assertEquals(fail.getRecordSetApiForZone("Z1PA6795UKMFR9").list().get(0).toImmutableSet(), ImmutableSet.of());
   }
   ...
   public void testList2PagesWhenResponseIs2xx() {
      ...
      assertEquals(success.getRecordSetApiForZone("Z1PA6795UKMFR9").list().concat().toImmutableSet(), new ListResourceRecordSetsResponseTest().expected()
            .toImmutableSet());
   }
