...
/**
 * Tests behavior of {@code QuantumClient}
 * 
 * @author Adam Lowe
 */
@Test(groups = "live")
public class BaseQuantumClientLiveTest extends BaseContextLiveTest<RestContext<QuantumClient, QuantumAsyncClient>> {

   public BaseQuantumClientLiveTest() {
      provider = "openstack-quantum";
   }

   protected RestContext<QuantumClient, QuantumAsyncClient> quantumContext;
   ...
   @Override
   protected TypeToken<RestContext<QuantumClient, QuantumAsyncClient>> contextType() {
