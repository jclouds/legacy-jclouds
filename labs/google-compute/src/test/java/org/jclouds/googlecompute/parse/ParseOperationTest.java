...
import org.jclouds.googlecompute.domain.OperationError;
import org.jclouds.googlecompute.domain.OperationErrors;
 ...
 */
@Test(groups = "unit")
public class ParseOperationTest extends BaseItemParserTest<Operation> {
   ...
   public Operation expected() {
      ...
      return Operation.builder().id("13053095055850848306")
              .selfLink("https://www.googleapis.com/compute/v1beta13/projects/myproject/operations/operation" +
                      "-1354084865060-4cf88735faeb8-bbbb12cb")
              .name("operation-1354084865060-4cf88735faeb8-bbbb12cb")
              .targetLink("https://www.googleapis.com/compute/v1beta13/projects/myproject/instances/instance-api-live" +
                      "-test-instance")
              ...
              .error(
                      OperationErrors.builder()
                              .addError(OperationError.builder()
