...
public class KernelApiExpectTest extends BaseGoogleComputeExpectTest<GoogleComputeApi> {
   ...
   public void testGetKernelResponseIs2xx() throws Exception {
      ...
      KernelApi kernelApi = requestsSendResponses(requestForScopes(COMPUTE_READONLY_SCOPE),
              TOKEN_RESPONSE, get, operationResponse).getKernelApi();

      assertEquals(kernelApi.get("myproject", "12941177846308850718"),
   ...
   public void testGetKernelResponseIs4xx() throws Exception {
      ...
      assertNull(kernelApi.get("myproject", "12941177846308850718"));
   }
   ...
   public void testListKernelNoOptionsResponseIs2xx() throws Exception {
      ...
      KernelApi kernelApi = requestsSendResponses(requestForScopes(COMPUTE_READONLY_SCOPE),
              TOKEN_RESPONSE, list, operationResponse).getKernelApi();

      assertEquals(kernelApi.list("myproject", ListOptions.NONE).toString(),
              toPagedIterable(new ParseKernelListTest().expected()).toString());
   }
   ...
   public void testListKernelsResponseIs4xx() {
      ...
      assertTrue(kernelApi.list("myproject", ListOptions.NONE).concat().isEmpty());
   }
