 ...
 */
@Test(groups = "unit")
public class ParseImageListTest extends BaseItemParserTest<PagedList<Image>> {
   ...
   public PagedList<Image> expected() {
      return PagedList.<Image>builder()
