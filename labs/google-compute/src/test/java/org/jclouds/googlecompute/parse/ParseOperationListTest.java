 ...
 * @author David Alves
 */
public class ParseOperationListTest extends BaseItemParserTest<PagedList<Operation>> {
   ...
   public PagedList<Operation> expected() {
      return PagedList.<Operation>builder()
