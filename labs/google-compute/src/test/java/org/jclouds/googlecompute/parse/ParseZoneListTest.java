...
import org.jclouds.googlecompute.domain.ZoneMaintenanceWindow;
 ...
 */
@Test(groups = "unit")
public class ParseZoneListTest extends BaseItemParserTest<PagedList<Zone>> {
   ...
   public PagedList<Zone> expected() {
      return PagedList.<Zone>builder()
              ...
              .items(ImmutableSet.of(
                      ...
                      .creationTimestamp(new SimpleDateFormatDateService().iso8601DateParse("2012-10-24T20:13:19.271"))
                      ...
                      .addMaintenanceWindow(ZoneMaintenanceWindow.builder()
                              .name("2013-02-17-planned-outage")
                              .description("maintenance zone")
                              .beginTime(new SimpleDateFormatDateService().iso8601DateParse("2013-02-17T08:00:00.000"))
                              .endTime(new SimpleDateFormatDateService().iso8601DateParse("2013-03-03T08:00:00.000"))
                              .build())
                      .build()))
              .build();
   }
