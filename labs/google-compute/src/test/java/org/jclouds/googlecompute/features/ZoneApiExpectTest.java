...
public class ZoneApiExpectTest extends BaseGoogleComputeExpectTest<GoogleComputeApi> {
   ...
   public void testGetZoneResponseIs2xx() throws Exception {
      HttpRequest get = HttpRequest
              ...
              .endpoint("https://www.googleapis" +
                      ".com/compute/v1beta13/projects/google/zones/us-central2-a")
      ...
      ZoneApi api = requestsSendResponses(requestForScopes(COMPUTE_READONLY_SCOPE),
              TOKEN_RESPONSE, get, operationResponse).getZoneApi();

      assertEquals(api.get("google", "us-central2-a"),
   ...
   public void testGetZoneResponseIs4xx() throws Exception {
      ...
      assertNull(api.get("google", "us-central2-a"));
   }
   ...
   public void testListZoneNoOptionsResponseIs2xx() throws Exception {
      HttpRequest list = HttpRequest
              ...
              .method("GET")
              .endpoint("https://www.googleapis" +
                      ".com/compute/v1beta13/projects/google/zones")
              .addHeader("Accept", "application/json")
              .addHeader("Authorization", "Bearer " + TOKEN).build();
      ...
      ZoneApi api = requestsSendResponses(requestForScopes(COMPUTE_READONLY_SCOPE),
              TOKEN_RESPONSE, list, operationResponse).getZoneApi();

      assertEquals(api.list("google", ListOptions.NONE).toString(),
              toPagedIterable(new ParseZoneListTest().expected()).toString());
   }
   ...
   public void testLisOperationWithPaginationOptionsResponseIs4xx() {
      ...
      assertTrue(api.list("google", ListOptions.NONE).concat().isEmpty());
   }
}
