 ...
 */
@Test(groups = "unit")
public class ParseKernelListTest extends BaseItemParserTest<PagedList<Kernel>> {
   ...
   public PagedList<Kernel> expected() {
      return PagedList.<Kernel>builder()
              ...
              .nextPageToken("CgZLRVJORUwSE2dvb2dsZS5nY2UtMjAxMTA5Mjk=")
