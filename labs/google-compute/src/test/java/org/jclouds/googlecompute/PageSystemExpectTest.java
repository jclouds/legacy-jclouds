...
public class PageSystemExpectTest extends BaseGoogleComputeApiExpectTest {
   ...
   public void testGetSinglePage() {
      ...
      PagedIterable<Image> images = imageApi.list("myproject", ListOptions.NONE);
   ...
   public void testGetMultiplePages() {
      ...
      HttpRequest list2 = HttpRequest
              ...
              .method("GET")
              .endpoint("https://www.googleapis" +
                      ".com/compute/v1beta13/projects/myproject/images?maxResults=3&pageToken" +
      ...
      ImageApi imageApi = orderedRequestsSendResponses(requestForScopes(COMPUTE_READONLY_SCOPE),
              TOKEN_RESPONSE, list1, list1response, list2, list2Response, list3, list3Response).getImageApi();

      PagedIterable<Image> images = imageApi.list("myproject", ListOptions.builder().maxResults(3).build());


      ImmutableList<IterableWithMarker<Image>> pages = images.toImmutableList();
      int imageCounter = 0;
      for (IterableWithMarker<Image> page : pages) {
