...
public class ImageApiLiveTest extends BaseGoogleComputeApiLiveTest {
   ...
   private ImageApi api() {
      return context.getApi().getImageApi();
   }

   @Test(groups = "live")
   public void testListImage() {

      PagedIterable<Image> images = api().list(GOOGLE_PROJECT, ListOptions.builder()
              .maxResults(1)
              .build());
   ...
   public void testGetImage() {
      Image image = api().get(GOOGLE_PROJECT, this.image.getName());
      assertNotNull(image);
