 ...
 * @author David Alves
 */
public class ParseMachineTypeListTest extends BaseItemParserTest<PagedList<MachineType>> {
   ...
   public PagedList<MachineType> expected() {
      SimpleDateFormatDateService dateService = new SimpleDateFormatDateService();
      return PagedList.<MachineType>builder()
