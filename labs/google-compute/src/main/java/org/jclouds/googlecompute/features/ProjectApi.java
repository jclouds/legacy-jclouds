...
public interface ProjectApi {
    ...
    *
    * @param projectName name of the project resource to retrieve.
    ...
    */
   public Operation setCommonInstanceMetadata(String projectName, Metadata commonInstanceMetadata);
