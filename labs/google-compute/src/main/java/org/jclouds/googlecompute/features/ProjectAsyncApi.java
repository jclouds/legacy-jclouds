...
public interface ProjectAsyncApi {
   ...
   public ListenableFuture<Project> get(@PathParam("project") String projectName);

   /**
    * @see ProjectApi#setCommonInstanceMetadata(String, Metadata)
    */
   @POST
   ...
   public ListenableFuture<Operation> setCommonInstanceMetadata(@PathParam("project") String projectName,
                                                                @BinderParam(BindToJsonPayload.class) Metadata
