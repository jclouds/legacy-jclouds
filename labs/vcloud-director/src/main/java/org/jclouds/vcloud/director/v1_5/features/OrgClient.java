...
public interface OrgClient {
    ...
    */
   ControlAccessParams modifyControlAccess(URI orgRef, URI catalogRef, ControlAccessParams params);
    ...
    * @return the control access information
    */
   ControlAccessParams getControlAccess(URI orgRef, URI catalogRef);
