...
public class VAppTemplateClientLiveTest extends AbstractVAppClientLiveTest {
   ...
   @Test(testName = "GET /vApptemplate/{id}/guestCustomizationSection", dependsOnMethods = { "testInstantiateAndStartVApp" } )
   ...
   @Test(testName = "GET /vApptemplate/{id}/networkConnectionSection", dependsOnMethods = { "testInstantiateAndStartVApp" } )
