...
/**
 * Authentication filter switch controls with authentication method is used when interacting with the CDMI provider.
 * @see org.jclouds.snia.cdmi.v1.config.CDMIRestClientModule
...
public class AuthenticationFilterSwitch implements HttpRequestFilter {
   ...
   public AuthenticationFilterSwitch(HttpRequestFilter httpRequestFilter) {
