...
//    private Map<String, String> metadata = Maps.newHashMap();
      private Map<String, JsonBall> metadata = Maps.newHashMap(); //nagin
//      private Map<String,String> userMetaDataIn;
 ...
 //   public B metadata(Map<String, String> metadata) {
      ...
      public B fromContainer(Container in) {
    	  System.out.println("container.fromContainer");
...
//   private final Map<String, String> metadata;
   ...
   /**
    * Metadata for the container object. This field includes any user and system metadata
...
//   public Map<String, String> getMetadata() {
    ...
    * System metadata data is prefixed with cdmi.
