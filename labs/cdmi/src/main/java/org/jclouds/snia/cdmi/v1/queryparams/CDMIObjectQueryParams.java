...
/**
 * Generate CDMI object query parameters Note: The preferred implementation
 * would use jax-rs queryParam. However, the CDMI query parameters specification
 * does not conform to jax-rs queryParam of key=value separated by &. Rather it
 * follows the form: ?<fieldname>;<fieldname>;.... ?metadata:<prefix>;...
 * ?children:<from>-<to>;... ?value:<from>-<to>;...
 * 
