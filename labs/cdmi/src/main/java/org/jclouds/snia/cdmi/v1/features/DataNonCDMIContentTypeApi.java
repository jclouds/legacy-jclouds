...
public interface DataNonCDMIContentTypeApi {
	 ...
	 *         <pre>
	 */
	Payload getValue(String dataObjectName, DataObjectQueryParams queryParams);
	 ...
	 *  dataObject = get("myDataObject",ContainerQueryParams.Builder.any("myquery=anyQueryParam"));
	 * }
	 * 
	 *         <pre>
	 */
