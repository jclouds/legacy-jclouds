 ...
 */
@Test(groups = "live")
public class BaseSwiftClientLiveTest extends BaseContextLiveTest<RestContext<SwiftClient, SwiftAsyncClient>> {

   public BaseSwiftClientLiveTest() {
      provider = "openstack-swift";
   }

   protected RestContext<SwiftClient, SwiftAsyncClient> swiftContext;
   ...
   @Override
   protected TypeToken<RestContext<SwiftClient, SwiftAsyncClient>> contextType() {
