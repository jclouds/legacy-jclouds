...
public class CreateServerOptions implements MapBinder {
	...
	public boolean equals(Object object) {
		...
		if (object instanceof CreateServerOptions) {
			final CreateServerOptions other = CreateServerOptions.class
					.cast(object);
	...
	public <R extends HttpRequest> R bindToRequest(R request,Map<String, String> postParams) {
		MachineRequest machine = new MachineRequest(checkNotNull(postParams
				.get("name"), "name parameter not present"), checkNotNull(
				postParams.get("package"), "package parameter not present"),
				checkNotNull(postParams.get("dataset"),
						"dataset parameter not present"));
	...
	/**
	 * An arbitrary set of metadata key/value pairs can be set at provision
	 * time, but they must be prefixed with "metadata."
	 */
	...
	/**
	 * An arbitrary set of tags can be set at provision time, but they must be
	 * prefixed with "tag."
	 */
