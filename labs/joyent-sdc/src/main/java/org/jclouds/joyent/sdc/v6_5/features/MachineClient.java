...
public interface MachineClient {
	 ...
	 * 
	 * @param name
	 *            friendly name for this machine; default is a randomly
	 *            generated name
	 * @param packageSDC
	 *            Name of the package to use on provisioning; default is
	 *            indicated in ListPackages
	 * @param dataset
	 *            dataset URN; default is indicated in ListDatasets
	 * @param options
	 *            optional parameters to be passed into the machine creation
	 *            request
	 * @return the newly created machine
	 */
	Machine createMachine(String name, String packageSDC, String dataset,
