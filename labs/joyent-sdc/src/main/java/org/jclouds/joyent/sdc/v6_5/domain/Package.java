...
public class Package implements Comparable<Package> {
	...
	public static class Builder {
		...
		public Builder defaultPackage(boolean defaultPackage) {
		...
		public Builder fromPackage(Package in) {
			return name(in.getName()).memorySizeMb(
					in.getMemorySizeMb()).diskSizeGb(in.getDiskSizeGb()).swapSizeMb(in.getSwapSizeMb()).defaultPackage(in.isDefaultPackage());
		}
	}
