...
public class CloudWatchAsyncClientTest extends RestClientTest<CloudWatchAsyncClient> {
   ...
   public void testRegisterInstancesWithMeasure() throws SecurityException, NoSuchMethodException, IOException {
      ...
      try {
         assertPayloadEquals(
               request,
               "Version=2010-08-01&Action=GetMetricStatistics&Statistics.member.1=Average&StartTime=1970-01-01T02%3A46%3A40Z&Namespace=AWS%2FEC2&&MetricName=CPUUtilization&EndTime=1970-01-01T02%3A46%3A40Z&Period=60&Dimensions.member.1.Name=InstanceId&Dimensions.member.1.Value=i-12312313",
