...
New features include support HP Cloud Object Storage, solid state drive (SSD) support for Cloudsigma Zurich, and the ability to automatically assign public IP addresses on Eucalyptus.
