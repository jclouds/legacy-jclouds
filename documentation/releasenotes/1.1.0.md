...
| org.jclouds.provider/cloudsigma-zrh| compute| CH-ZH| [pass](http://code.google.com/p/jclouds/issues/attachmentText?id=641&aid=6410037000&name=cloudsigma-zrh.txt&token=4857a89c1098866767d743cdb89c19c9 unknown]| operations seem to work fine, but since images don't support automated ssh login, we cannot verify| 
...
| org.jclouds.provider/eucalyptus-partnercloud-ec2| compute| US-CA| [pass](http://code.google.com/p/jclouds/issues/attachmentText?id=641&aid=6410025000&name=eucalyptus-partnercloud-ec2.txt&token=49205b56e47672af46bfa874ed4895dc unknown]| account doesn't have enough resources to verify things operate| 
| org.jclouds.provider/eucalyptus-partnercloud-s3| blobstore| US-CA| [pass](http://code.google.com/p/jclouds/issues/attachmentText?id=641&aid=6410018000&name=eucalyptus-partnercloud-s3.txt&token=d967dc03d3d8a07e389b8848d051e216 unstable]| acls are not compatible with s3 (testPublicReadOnObject,testPublicWriteOnObject,testUpdateObjectACL); lack of NextMarker makes list continuations unreliable (testListContainerMarker testPutMoreThanSingleListing); different http code on etag conditional (testGetIfMatch)| 
| org.jclouds.provider/gogrid| compute| US-CA,US-VA| [pass](http://code.google.com/p/jclouds/issues/attachmentText?id=641&aid=6410019000&name=gogrid.txt&token=b556956bf7b31350ac00ae38f4dfbafb unstable]| sometimes metadata like running status flip off our tests.  Since I cannot get a clean run after several tries, I marking this unstable conceding most tests do pass.| 
...
| org.jclouds.provider/rimuhosting| compute| NZ-AUK,US-TX,AU-NSW,GB-LND| [pass](http://code.google.com/p/jclouds/issues/attachmentText?id=641&aid=6410033001&name=rimuhosting.txt&token=33f5976e615fc8db2017379a89a47dad unstable]| rimuhosting works while servers are launched sequentially.  During the tests, servers launched sequentially operated as expected, but when 2 were launched at the same time, we started to receive unexpected content back from the rest api| 
| org.jclouds.provider/savvis-symphonyvpdc| compute| US,CA| [pass](http://jclouds.googlecode.com/issues/attachment?aid=6410011000&name=jclouds_savvis-symphonyvpdc_livetests_reports_07282011.zip&token=f95192bf5511519333f1187ac64c7afd unstable]|   NOTE this provider does not yet implement ComputeService interface, so you have to use the provider api; a few minor tests fail, and since we don't have comprehensive support due to lacking ComputeService impl, marking unstable| 
