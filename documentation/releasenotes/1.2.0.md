...
Next release will be in about X months
and look for progress including Y and Z
...
We now support the cloud watch api, users can use 'tags' when creating nodes and we have upgraded to the latest Amazon Linux version.

### Upgrades
We have updated various components to new versions including Clojure 1.3, Guava 10.1,
Sshkj 0.6.1, and the latest version of Elastic Stack.
